...
public class HeaderAndFooterViewUtil {
	...
	public static View getHeadView(Context context, boolean isVertical, int bgColor, String text) {
		...
		if (isVertical) {
			headview.setLayoutParams(new FamiliarRecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
					ViewGroup.LayoutParams.WRAP_CONTENT)); // vertical
		} else {
			headview.setLayoutParams(new FamiliarRecyclerView.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
					ViewGroup.LayoutParams.MATCH_PARENT)); // horizontal
		}
		...
		if (isVertical) {
			headviewContentParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, dip2px(context,
					150));
		} else {
			headviewContentParams = new FrameLayout.LayoutParams(dip2px(context, 150),
	...
	public static View getFooterView(Context context, boolean isVertical, int bgColor, String text) {
		...
		if (isVertical) {
			footer1.setLayoutParams(new FamiliarRecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
					ViewGroup.LayoutParams.WRAP_CONTENT)); // vertical
		} else {
			footer1.setLayoutParams(new FamiliarRecyclerView.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
					ViewGroup.LayoutParams.MATCH_PARENT)); // horizontal
		}
		...
		if (isVertical) {
			footerviewContent1Params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, dip2px(
					context, 150));
		} else {
			footerviewContent1Params = new FrameLayout.LayoutParams(dip2px(context, 150),
					ViewGroup.LayoutParams.WRAP_CONTENT);
		}
