...
/**
 * Wrap FamiliarRecyclerView Adapter Created by iWgang on 15/10/31.
 * https://github.com/iwgang/FamiliarRecyclerView
 */
@SuppressWarnings("rawtypes")
public class FamiliarWrapRecyclerViewAdapter extends RecyclerView.Adapter implements View.OnClickListener,
	...
	public FamiliarWrapRecyclerViewAdapter(FamiliarRecyclerView familiarRecyclerView, RecyclerView.Adapter reqAdapter,
			List<View> mHeaderView, List<View> mFooterView, int layoutManagerType) {
	...
	public void onClick(View v) {
		...
		if (null != mOnItemClickListener && curTime - mLastClickTime > MIN_INTERVAL_CLICK_TIME) {
			...
			mOnItemClickListener.onItemClick(mFamiliarRecyclerView, v, mFamiliarRecyclerView.getChildAdapterPosition(v)
					- mFamiliarRecyclerView.getHeaderViewsCount());
		}
	}
	...
	public boolean onLongClick(View v) {
		...
		if (null != mOnItemClickListener && curTime - mLastClickTime > MIN_INTERVAL_CLICK_TIME) {
			mLastClickTime = curTime;
			return mOnItemLongClickListener.onItemLongClick(mFamiliarRecyclerView, v,
					mFamiliarRecyclerView.getChildAdapterPosition(v) - mFamiliarRecyclerView.getHeaderViewsCount());
		}
		return false;
	}
