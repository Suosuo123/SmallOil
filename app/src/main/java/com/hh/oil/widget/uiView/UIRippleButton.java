package com.hh.oil.widget.uiView;
...
public class UIRippleButton extends UIBaseButton {
    ...
    protected void init(final Context context, final AttributeSet attrs) {
        ...
        mRoundRadius = typedArray.getDimensionPixelSize(R.styleable.UIButton_ripple_radius, getResources().getDimensionPixelSize(R.dimen.ui_radius));
        typedArray.recycle();
