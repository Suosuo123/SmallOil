...
public class WaterDropView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		// mPaint);
		RectF bitmapArea = new RectF(topCircle.getX() - 0.5f * topCircle.getRadius(), topCircle.getY() - 0.5f
				* topCircle.getRadius(), topCircle.getX() + 0.5f * topCircle.getRadius(), topCircle.getY() + 0.5f
				* topCircle.getRadius());
	...
	public Animator createAnimator() {
		...
		valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator valueAnimator) {
				...
				updateComleteState(valueAnimator.getAnimatedFraction());
			}
		});
