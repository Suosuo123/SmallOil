 ...
 */
package com.hh.oil.widget.waterDrop;
...
public class WaterDropListView extends ListView implements OnScrollListener,
	...
	/**
	 * reset header view's height. 重置headerheight的高度
	 * 逻辑：1、如果状态处于非refreshing，则回滚到height
	 * =0状态2；2、如果状态处于refreshing，则回滚到stretchheight高度
	 */
	private void resetHeaderHeight() {
		...
		if ((mHeaderView.getCurrentState() == WaterDropListViewHeader.STATE.ready || mHeaderView.getCurrentState() == WaterDropListViewHeader.STATE.refreshing)
				&& height > mHeaderView.getStretchHeight()) {
